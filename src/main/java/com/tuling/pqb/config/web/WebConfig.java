...
import com.tuling.pqb.core.common.controller.GunsErrorView;
import com.tuling.pqb.core.interceptor.AttributeSetInteceptor;
import com.tuling.pqb.core.interceptor.RestApiInteceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private PqbProperties pqbProperties;
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        if (pqbProperties.getSwaggerOpen()) {
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        String patterns = "com.tuling.pqb.modular.*.service.*";
        //可以set多个
