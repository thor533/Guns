...
CREATE DATABASE IF NOT EXISTS party_question_bank DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

USE party_question_bank;
/*
 Navicat Premium Data Transfer

 Source Server         : 218.56.134.116_1533
 Source Server Type    : MySQL
 Source Server Version : 50723
 Source Host           : 218.56.134.116:1533
 Source Schema         : party_question_bank

 Target Server Type    : MySQL
 Target Server Version : 50723
 File Encoding         : 65001

 Date: 13/07/2020 21:08:30
*/
...
-- ----------------------------
INSERT INTO `sys_login_log` VALUES (1282647098478084097, '登录日志', 1, '2020-07-13 20:04:33', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1282655717466591234, '登录日志', 1, '2020-07-13 20:38:48', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1282657830095613954, '登录失败日志', NULL, '2020-07-13 20:47:11', '成功', '账号:admin,账号密码错误', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1282657844100395009, '登录日志', 1, '2020-07-13 20:47:15', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1282659532102197250, '登录日志', 1, '2020-07-13 20:53:57', '成功', NULL, '0:0:0:0:0:0:0:1');
...
CREATE TABLE `sys_menu`  (
  ...
  `levels` int(11) NULL DEFAULT NULL COMMENT '菜单层级',
...
-- ----------------------------
INSERT INTO `sys_operation_log` VALUES (1282655882424373249, '业务日志', '删除菜单', 1, 'com.tuling.pqb.modular.system.controller.MenuController', 'remove', '2020-07-13 20:39:28', '成功', '菜单名称=项目介绍');
INSERT INTO `sys_operation_log` VALUES (1282656098099679234, '业务日志', '删除通知', 1, 'com.tuling.pqb.modular.system.controller.NoticeController', 'delete', '2020-07-13 20:40:19', '成功', '标题=欢迎');
INSERT INTO `sys_operation_log` VALUES (1282660299932459009, '业务日志', '删除菜单', 1, 'com.tuling.pqb.modular.system.controller.MenuController', 'remove', '2020-07-13 20:57:01', '成功', '菜单名称=统计报表');
